/*
 ...
 @version {version}
*/
(function(b){function B(l,p){function r(c,h){var i=b(c.target).offset(),m;clearTimeout(o);o=false;if(typeof c.changedTouches!=="undefined"){m=Math.floor(c.changedTouches[0].pageX-i.left);i=Math.floor(c.changedTouches[0].pageY-i.top)}else{m=Math.floor(c.pageX-i.left);i=Math.floor(c.pageY-i.top)}if(g.x===m&&g.y===i)return true;if(g.x===null)g.x=m;if(g.y===null)g.y=i;if(h)i+=h;e.beginPath();e.moveTo(g.x,g.y);e.lineTo(m,i);e.lineCap=a.penCap;e.stroke();e.closePath();j.push({lx:m,ly:i,mx:g.x,my:g.y});
g.x=m;g.y=i}function n(){q?f.each(function(){this.ontouchmove=null}):f.unbind("mousemove.signaturepad");g.x=null;g.y=null;j.length>0&&b(a.output,d).val(JSON.stringify(j))}function s(){n();e.fillStyle=a.bgColour;e.fillRect(0,0,k.width,k.height);if(!a.displayOnly){e.beginPath();e.lineWidth=a.lineWidth;e.strokeStyle=a.lineColour;e.moveTo(a.lineMargin,a.lineTop);e.lineTo(k.width-a.lineMargin,a.lineTop);e.stroke();e.closePath()}e.lineWidth=a.penWidth;e.strokeStyle=a.penColour;b(a.output,d).val("");j=[]}
function v(c){q?f.each(function(){this.addEventListener("touchmove",r,false)}):f.bind("mousemove.signaturepad",r);r(c,1)}function C(){t=false;if(q)f.each(function(){this.removeEventListener("touchstart",n);this.removeEventListener("touchend",n);this.removeEventListener("touchmove",r)});else{f.unbind("mousedown.signaturepad");f.unbind("mouseup.signaturepad");f.unbind("mousemove.signaturepad");f.unbind("mouseleave.signaturepad")}b(a.clear,d).unbind("click.signaturepad")}function w(c){if(t)return false;
...
function(c){return b(c.target).is(":input")});!k.getContext&&FlashCanvas&&FlashCanvas.initElement(k);if(k.getContext){e=k.getContext("2d");b(a.sig,d).show();if(!a.displayOnly){if(!a.drawOnly){b(a.name,d).bind("keyup.signaturepad",function(){y(b(this).val())});b(a.name,d).bind("blur.signaturepad",function(){y(b(this).val())});b(a.drawIt,d).bind("mousedown.signaturepad",function(c){c.preventDefault();u()})}a.drawOnly||a.defaultAction==="drawIt"?u():x();if(a.validateFields)b(l).is("form")?b(l).bind("submit.signaturepad",
function(){return z()}):b(l).parents("form").bind("submit.signaturepad",function(){return z()});b(a.sigNav,d).show()}}}var A=this,a=b.extend({},b.fn.signaturePad.defaults,p),d=b(l),f=b(a.canvas,d),k=f.get(0),e=null,g={x:null,y:null},j=[],o=false,q=false,t=false;b.extend(A,{init:function(){D()},regenerate:function(c){A.clearCanvas();b(a.typed,d).hide();if(typeof c==="string")c=JSON.parse(c);for(var h in c)if(typeof c[h]==="object"){e.beginPath();e.moveTo(c[h].mx,c[h].my);e.lineTo(c[h].lx,c[h].ly);
e.lineCap=a.penCap;e.stroke();e.closePath();j.push({lx:c[h].lx,ly:c[h].ly,mx:c[h].mx,my:c[h].my})}b(a.output,d).length>0&&b(a.output,d).val(JSON.stringify(j))},clearCanvas:function(){s()},getSignature:function(){return j},getSignatureString:function(){return JSON.stringify(j)},getSignatureImage:function(){return k.toDataURL()}})}b.fn.signaturePad=function(l){var p=null;this.each(function(){p=new B(this,l);p.init()});return p};b.fn.signaturePad.defaults={defaultAction:"typeIt",displayOnly:false,drawOnly:false,
canvas:"canvas",sig:".sig",sigNav:".sigNav",bgColour:"#ffffff",penColour:"#145394",penWidth:2,penCap:"round",lineColour:"#ccc",lineWidth:2,lineMargin:5,lineTop:35,name:".name",typed:".typed",clear:".clearButton",typeIt:".typeIt a",drawIt:".drawIt a",typeItDesc:".typeItDesc",drawItDesc:".drawItDesc",output:".output",currentClass:"current",validateFields:true,errorClass:"error",errorMessage:"Please enter your name",errorMessageDraw:"Please sign the document"}})(jQuery);
